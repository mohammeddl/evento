...
@section('content')
<div class="flex w-full max-w-sm mx-auto my-12 overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
    <div class="hidden bg-cover bg-center lg:block lg:w-1/2" style="background-image: url('{{asset('images/login.png')}}');"></div>

    <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
        <p class="flex justify-center mx-auto mt-3 text-xl text-center text-gray-600 dark:text-gray-200">
            Welcome back!
        </p>
