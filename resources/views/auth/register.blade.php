...
<section class="relative flex flex-col items-center justify-center w-full px-6 pb-6 bg-white bg-cover lg:pb-6 min-w-screen">
    <div class="flex flex-col items-center justify-center mx-auto xl:px-8 lg:flex-row lg:max-w-6xl lg:px-0">
        <div class="container relative z-20 flex flex-col w-full px-5 pb-1 pr-12 mb-16 text-2xl text-gray-700 lg:w-1/2 sm:pr-0 md:pr-6 md:pl-0 lg:pl-5 xl:pr-10 sm:items-center lg:items-start lg:mb-0">
            <h1 class="relative z-20 text-5xl font-extrabold leading-none text-indigo-500 xl:text-6xl sm:text-center lg:text-left">
                Join Evento <br>
                <span class="mt-1 text-gray-800 lg:mt-0">Today!</span>
            </h1>
            <p class="relative z-20 block mt-6 text-base text-gray-500 xl:text-xl sm:text-center lg:text-left">Create your account and start discovering, booking, and generating tickets for a variety of events.</p>
                ...
                <section class=" dark:bg-gray-900">
                    <div class="container flex items-center justify-center  pb-6 px-6 mx-auto">
                        ...
                        <form class="w-full max-w-md" method="POST" action="{{route('register.store')}}" enctype="multipart/form-data">
                            @csrf
                                <a href="{{route('google')}}" class="flex items-center justify-center mt-10 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <div class="px-4 py-2">
