        ...
        <div class="ticket" aria-hidden="true">
          <div class="ticket__header">
            <div class="ticket__co">
              ...
              <span class="u-upper ticket__co-subname">Creating Moments to Remember</span>
            </div>
          </div>
          <div class="ticket__body">
            <p class="ticket__route">{{$userName}}</p>
            ...
            <div class="ticket__timing">
              <p>
                ...
                <span class="ticket__detail"{{$eventPrice}}></span>
              </p>
            </div>
            <p class="ticket__fine-print">This ticket cannot be transferred to another Events</p>
            <p class="u-upper ticket__admit">{{$ticketId}}</p>
